...
if SERVER then
    ...
    hook.Add("EntityTakeDamage", "FlareGun_FireDamageAttribution", function(victim, dmginfo)
    ...
    hook.Add("Initialize", "FlareGun_InitOverride", function()
        -- Find and enhance the weapon if it exists
        if weapons.GetStored("weapon_ttt_flaregun") then
